    ...
    <div class="col-10">
        <table class="table table-bordered">
            ...
            <?php for ($i = 0; $i < sizeof($_SESSION['products']); $i++): ?>
                <tr>
                    <td> <?php echo ($i + 1); ?> </td>
                    <td> <?php echo  $_SESSION['products'][$i]["name"]; ?></td>
                    <td> <?php echo $_SESSION['products'][$i]["code"]; ?></td>
                    <td> <?php echo $_SESSION['products'][$i]['supplier']; ?></td>
                    <td> <?php echo 'R$' . $_SESSION['products'][$i]["price"]; ?></td>
                    <td> <?php echo $_SESSION['products'][$i]["amount"]; ?></td>
                    <td> <?php echo 'R$' . $_SESSION['products'][$i]["profit"]; ?></td>
                </tr>
            <?php endfor; ?>
        </table>
    </div>
